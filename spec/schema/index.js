...
// @wdk-core/quoteSendTransactionTX-request-options
const encoding48 = {
  preencode (state, m) {
    c.string.preencode(state, m.to)
    c.string.preencode(state, m.value)
    ...
    if (version >= 5 && m.feeRate) c.string.preencode(state, m.feeRate)
    if (version >= 5 && m.confirmationTarget) c.uint.preencode(state, m.confirmationTarget)
  },
  encode (state, m) {
    const flags =
      ((version >= 5 && m.feeRate) ? 1 : 0) |
      ((version >= 5 && m.confirmationTarget) ? 2 : 0)

    c.string.encode(state, m.to)
    c.string.encode(state, m.value)
    c.uint.encode(state, flags)

    if (version >= 5 && m.feeRate) c.string.encode(state, m.feeRate)
    if (version >= 5 && m.confirmationTarget) c.uint.encode(state, m.confirmationTarget)
  },
  decode (state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      to: r0,
      value: r1,
      feeRate: (version >= 5 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      confirmationTarget: (version >= 5 && (flags & 2) !== 0) ? c.uint.decode(state) : 0
    }
  }
}

// @wdk-core/quoteSendTransactionTX-request.options
const encoding49_2 = c.frame(encoding48)

// @wdk-core/quoteSendTransactionTX-request
const encoding49 = {
  preencode (state, m) {
    c.string.preencode(state, m.network)
    c.uint.preencode(state, m.accountIndex)
    encoding49_2.preencode(state, m.options)
  },
  encode (state, m) {
    c.string.encode(state, m.network)
    c.uint.encode(state, m.accountIndex)
    encoding49_2.encode(state, m.options)
  },
  decode (state) {
    const r0 = c.string.decode(state)
    const r1 = c.uint.decode(state)
    const r2 = encoding49_2.decode(state)
...
// @wdk-core/quoteSendTransactionTX-response
const encoding50 = {
  preencode (state, m) {
    state.end++ // max flag is 1 so always one byte

    if (version >= 5 && m.txHex) c.string.preencode(state, m.txHex)
  },
  encode (state, m) {
    const flags = (version >= 5 && m.txHex) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 5 && m.txHex) c.string.encode(state, m.txHex)
  },
  decode (state) {
    const flags = c.uint.decode(state)

    return {
      txHex: (version >= 5 && (flags & 1) !== 0) ? c.string.decode(state) : null
    }
  }
}

// @wdk-core/deriveTaprootAddressesFromPaths-request
const encoding51 = {
  preencode (state, m) {
    c.string.preencode(state, m.relativePathsJson)
  },
  encode (state, m) {
    c.string.encode(state, m.relativePathsJson)
  },
  decode (state) {
    const r0 = c.string.decode(state)

    return {
      relativePathsJson: r0
    }
  }
}

// @wdk-core/deriveTaprootAddressesFromPaths-response
const encoding52 = {
  preencode (state, m) {
    state.end++ // max flag is 1 so always one byte

    if (version >= 6 && m.addressesJson) c.string.preencode(state, m.addressesJson)
  },
  encode (state, m) {
    const flags = (version >= 6 && m.addressesJson) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 6 && m.addressesJson) c.string.encode(state, m.addressesJson)
  },
  decode (state) {
    const flags = c.uint.decode(state)

    return {
      addressesJson: (version >= 6 && (flags & 1) !== 0) ? c.string.decode(state) : null
    }
  }
}

// @wdk-core/quoteUpdateTransactionWithHexTX-request-options
const encoding53 = {
  preencode (state, m) {
    c.string.preencode(state, m.to)
    c.string.preencode(state, m.hex)
    c.string.preencode(state, m.priorTx)
    c.string.preencode(state, m.priorAccountRelativePath)
    state.end++ // max flag is 4 so always one byte

    if (version >= 6 && m.value) c.string.preencode(state, m.value)
    if (version >= 6 && m.feeRate) c.string.preencode(state, m.feeRate)
    if (version >= 6 && m.confirmationTarget) c.uint.preencode(state, m.confirmationTarget)
  },
  encode (state, m) {
    const flags =
      ((version >= 6 && m.value) ? 1 : 0) |
      ((version >= 6 && m.feeRate) ? 2 : 0) |
      ((version >= 6 && m.confirmationTarget) ? 4 : 0)

    c.string.encode(state, m.to)
    c.string.encode(state, m.hex)
    c.string.encode(state, m.priorTx)
    c.string.encode(state, m.priorAccountRelativePath)
    c.uint.encode(state, flags)

    if (version >= 6 && m.value) c.string.encode(state, m.value)
    if (version >= 6 && m.feeRate) c.string.encode(state, m.feeRate)
    if (version >= 6 && m.confirmationTarget) c.uint.encode(state, m.confirmationTarget)
  },
  decode (state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      hex: r1,
      priorTx: r2,
      priorAccountRelativePath: r3,
      value: (version >= 6 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      feeRate: (version >= 6 && (flags & 2) !== 0) ? c.string.decode(state) : null,
      confirmationTarget: (version >= 6 && (flags & 4) !== 0) ? c.uint.decode(state) : 0
    }
  }
}

const encoding54_2 = c.frame(encoding53)

// @wdk-core/quoteUpdateTransactionWithHexTX-request
const encoding54 = {
  preencode (state, m) {
    c.string.preencode(state, m.network)
    c.uint.preencode(state, m.fundingAccountIndex)
    encoding54_2.preencode(state, m.options)
  },
  encode (state, m) {
    c.string.encode(state, m.network)
    c.uint.encode(state, m.fundingAccountIndex)
    encoding54_2.encode(state, m.options)
  },
  decode (state) {
    const r0 = c.string.decode(state)
    const r1 = c.uint.decode(state)
    const r2 = encoding54_2.decode(state)

    return {
      network: r0,
      fundingAccountIndex: r1,
      options: r2
    }
  }
}

// @wdk-core/quoteUpdateTransactionWithHexTX-response (txHex + optional fee in satoshis as string)
const encoding55 = {
  preencode (state, m) {
    state.end++ // max flag is 3 so always one byte

    if (version >= 6 && m.txHex) c.string.preencode(state, m.txHex)
    if (version >= 6 && m.fee) c.string.preencode(state, m.fee)
  },
  encode (state, m) {
    const flags =
      ((version >= 6 && m.txHex) ? 1 : 0) |
      ((version >= 6 && m.fee) ? 2 : 0)

    c.uint.encode(state, flags)

    if (version >= 6 && m.txHex) c.string.encode(state, m.txHex)
    if (version >= 6 && m.fee) c.string.encode(state, m.fee)
  },
  decode (state) {
    const flags = c.uint.decode(state)

    return {
      txHex: (version >= 6 && (flags & 1) !== 0) ? c.string.decode(state) : null,
      fee: (version >= 6 && (flags & 2) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
function getEncoding (name) {
  switch (name) {
    ...
    case '@wdk-core/quoteSendTransactionTX-request-options': return encoding48
    case '@wdk-core/quoteSendTransactionTX-request': return encoding49
    case '@wdk-core/quoteSendTransactionTX-response': return encoding50
    case '@wdk-core/deriveTaprootAddressesFromPaths-request': return encoding51
    case '@wdk-core/deriveTaprootAddressesFromPaths-response': return encoding52
    case '@wdk-core/quoteUpdateTransactionWithHexTX-request-options': return encoding53
    case '@wdk-core/quoteUpdateTransactionWithHexTX-request': return encoding54
    case '@wdk-core/quoteUpdateTransactionWithHexTX-response': return encoding55
    case '@wdk-core/updateTransactionWithHex-request-options': return encoding53
    case '@wdk-core/updateTransactionWithHex-request': return encoding54
    case '@wdk-core/updateTransactionWithHex-response': return encoding13
